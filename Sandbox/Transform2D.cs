...
namespace Sandbox
{
    internal class Transform2D
    {
        ...
        private Matrix3 _localRotaion = Matrix3.Identity;
        ...
        public Matrix3 LocalRation
        {
            get { return _localRotaion; }
            set
            {
                // Set _localRotation
                _localRotaion = value;
                //Set _localRotationAngle
                _localRotationAngle = (float)Math.Atan2(_localRotaion.m01, _localRotaion.m00);
            }
        }
